...
namespace DigitaLibrary.Migrations
{
    ...
    [Migration("20250821061344_newmodel")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DigitaLibrary.Models.Category", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 3,
                            Name = "Mühendislik ve Teknoloji",
                            Slug = "muhendislik-teknoloji"
                        },
                        new
                        {
                            Id = 4,
                        ...
                        {
                            Id = 6,
                            Name = "Beşeri Bilimler",
                            Slug = "beseri-bilimler"
                        },
                        new
                        {
                            Id = 7,
                            Name = "Uygulamalı Bilimler",
                            Slug = "uygulamali-bilimler"
                        },
                        new
                        {
                            Id = 8,
            ...
            modelBuilder.Entity("DigitaLibrary.Models.UserRating", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DigitaLibrary.Models.UserRating", b =>
                {
                    b.HasOne("Admin", "RatedUser")
                        .WithMany()
                        .HasForeignKey("RatedUserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Admin", "Rater")
                        .WithMany()
